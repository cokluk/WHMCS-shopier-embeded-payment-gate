...
function shopier_link($params)
{
    ...
    $htmlOutput = '<form method="post" target="my-iframe" action="' . $url . '">';
    foreach ($postfields as $k => $v) {
        $htmlOutput .= '<input type="hidden" name="' . $k . '" value="' . $v . '" />';
    }
    $htmlOutput .= '<input style="display:none;" type="submit" value="' . $langPayNow . '" />';
    $htmlOutput .= '</form>';
	
	$htmlOutput .= '<iframe xpslh="by salih cokluk" id="odeme" name="my-iframe" class="odemeyeri" src="/yonlendirileceksiniz.php"></iframe><xpslh></xpslh>';
